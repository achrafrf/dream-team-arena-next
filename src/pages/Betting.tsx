    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Place your bets on upcoming matches and check fixture schedules</p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="fixtures" className="mt-6">
            <Card className="shadow-md">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <CalendarDays className="h-5 w-5 text-fantasy-purple" />
                  <span>Upcoming Fixtures</span>
                </CardTitle>
                <CardDescription>Full list of all upcoming matches</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <TableBody>
                      {fixtures.map((fixture) => (
                        <TableRow key={fixture.id}>
                          ...
                          <TableCell className="hidden lg:table-cell">{fixture.competition}</TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </Table>
